      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        ...
        {isLoading || (!formik.values && !error) ? (
          ...
          <form onSubmit={formik.handleSubmit}>
            <FormControl id="card_progress" mb="4" isInvalid={!!formik.errors?.card_progress}>
              <FormLabel>Card Progress</FormLabel>
              <NumberInput
                name="card_progress"
                value={formik.values?.card_progress}
                onChange={(valueString, valueNumber) =>
                  formik.setFieldValue('card_progress', Number.isNaN(valueNumber) ? 0 : valueNumber)
                }
              >
                <NumberInputField />
                <NumberInputStepper>
              ...
              {formik.errors.card_progress && <FormErrorMessage>{formik.errors?.card_progress}</FormErrorMessage>}
            </FormControl>
